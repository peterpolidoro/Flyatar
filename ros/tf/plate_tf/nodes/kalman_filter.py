...
class KalmanFilter:
    def __init__(self):
        ...
        cv.SetIdentity(self.kal.process_noise_cov, 1000000000000000000)
        cv.SetIdentity(self.kal.measurement_noise_cov, 0.00000000000000000001)
    ...
    def update_dt(self):
        ...
        if self.t_previous is not None:
            ...
            self.kal.transition_matrix[2,2] = self.dt_scale
            self.kal.transition_matrix[3,3] = self.dt_scale
            status = True
